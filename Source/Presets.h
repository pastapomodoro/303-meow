...
//
// Tutti i pattern sono scritti sulla root C2 (36) = StepSequencer::PATTERN_ROOT,
// cosi' in MIDI mode la nota del piano roll traspone la bassline in modo
// prevedibile: C2 la suona come scritta, G2 la porta una quinta sopra.
...
static const std::array<PresetData, 10> FACTORY_PRESETS = {{
    ...
    {"Nightshade Run",  620.f,.82f,.62f,.42f,.78f,.82f,.28f,.0f,132.f,0,
     ...
     {{36,1,1,0,0},{48,1,0,1,0},{46,1,0,0,0},{43,1,0,0,0},
      {39,1,0,0,0},{36,1,0,0,0},{43,1,0,1,0},{46,1,0,0,0},
      {48,1,1,0,0},{46,1,0,0,0},{43,1,0,0,0},{41,1,0,1,0},
      {39,1,0,0,0},{38,1,0,0,0},{37,1,0,0,0},{36,1,0,0,0}}},

    // 2 — sinuosa, cromatismi sul m6 e sul maj7
    {"Copper Coil",     480.f,.90f,.74f,.55f,.80f,.80f,.35f,.0f,128.f,1,
     .333f,.40f,.12f,.55f,.08f, 16,
     {{36,1,1,0,0},{39,1,0,0,0},{36,1,0,0,0},{43,1,0,1,0},
      {44,1,0,0,0},{43,1,0,0,0},{41,1,0,0,0},{39,1,0,1,0},
      {36,1,1,0,0},{48,1,0,0,0},{47,1,0,1,0},{46,1,0,0,0},
      {43,1,0,0,0},{39,1,0,0,0},{37,1,0,0,0},{36,1,0,0,0}}},
    ...
    {"Glass Meridian",  880.f,.68f,.55f,.30f,.75f,.82f,.22f,.0f,138.f,0,
     ...
     {{36,1,1,0,0},{38,1,0,0,0},{39,1,0,0,0},{43,1,0,0,0},
      {46,1,0,1,0},{48,1,0,0,0},{51,1,0,0,0},{48,1,0,0,0},
      {46,1,1,0,0},{43,1,0,0,0},{39,1,0,1,0},{38,1,0,0,0},
      {36,1,0,0,0},{43,1,0,1,0},{39,1,0,0,0},{36,1,0,0,0}}},

    // 4 — profonda, pause a dare groove
    {"Ferrite Bloom",   360.f,.92f,.80f,.68f,.82f,.78f,.38f,.0f,126.f,1,
     .250f,.45f,.18f,.60f,.12f, 16,
     {{36,1,1,0,0},{36,0,0,0,0},{39,1,0,0,0},{36,1,0,0,0},
      {36,0,0,0,0},{43,1,0,1,0},{41,1,0,0,0},{36,1,0,0,0},
      {36,1,1,0,0},{36,0,0,0,0},{46,1,0,0,0},{43,1,0,0,0},
      {36,0,0,0,0},{39,1,0,1,0},{37,1,0,0,0},{36,1,0,0,0}}},

    // 5 — decay lungo, linea che respira
    {"Undertow",        540.f,.76f,.58f,.95f,.74f,.80f,.25f,.0f,122.f,0,
     .500f,.48f,.25f,.70f,.22f, 16,
     {{36,1,1,0,0},{36,1,0,0,0},{43,1,0,0,0},{46,1,0,1,0},
      {48,1,0,0,0},{46,1,0,0,0},{43,1,0,0,0},{39,1,0,0,0},
      {41,1,1,0,0},{43,1,0,0,0},{39,1,0,0,0},{36,1,0,0,0},
      {38,1,0,1,0},{39,1,0,0,0},{43,1,0,1,0},{36,1,0,0,0}}},
    ...
    {"Static Prayer",   700.f,.94f,.70f,.35f,.84f,.78f,.32f,.0f,140.f,1,
     ...
     {{48,1,1,0,0},{46,1,0,0,0},{43,1,0,0,0},{39,1,0,0,0},
      {36,1,0,1,0},{39,1,0,0,0},{43,1,0,0,0},{46,1,0,0,0},
      {48,1,1,0,0},{51,1,0,0,0},{48,1,0,0,0},{46,1,0,0,0},
      {43,1,0,1,0},{39,1,0,0,0},{37,1,0,1,0},{36,1,0,0,0}}},
    ...
    {"Lithium Dawn",   1150.f,.64f,.50f,.24f,.72f,.84f,.18f,.0f,145.f,0,
     ...
     {{36,1,1,0,0},{43,1,0,0,0},{48,1,0,0,0},{43,1,0,0,0},
      {39,1,0,1,0},{46,1,0,0,0},{51,1,0,1,0},{46,1,0,0,0},
      {36,1,1,0,0},{43,1,0,0,0},{48,1,0,0,0},{55,1,0,0,0},
      {48,1,0,1,0},{43,1,0,0,0},{39,1,0,0,0},{36,1,0,0,0}}},

    // 8 — passeggiata cromatica su due registri
    {"Verdigris",       580.f,.86f,.66f,.48f,.78f,.80f,.30f,.0f,130.f,1,
     .333f,.42f,.15f,.55f,.10f, 16,
     {{36,1,1,0,0},{39,1,0,0,0},{37,1,0,0,0},{36,1,0,0,0},
      {43,1,0,1,0},{41,1,0,0,0},{39,1,0,0,0},{36,1,0,0,0},
      {46,1,1,0,0},{44,1,0,0,0},{43,1,0,0,0},{39,1,0,0,0},
      {48,1,0,1,0},{46,1,0,0,0},{43,1,0,1,0},{36,1,0,0,0}}},
    ...
    {"Solvent Trails",  420.f,.58f,.48f,1.20f,.70f,.80f,.15f,.0f,118.f,0,
     ...
     {{36,1,1,0,0},{36,0,0,0,0},{43,1,0,0,0},{36,0,0,0,0},
      {46,1,0,1,0},{48,1,0,0,0},{36,0,0,0,0},{46,1,0,0,0},
      {43,1,1,0,0},{36,0,0,0,0},{39,1,0,0,0},{36,1,0,0,0},
      {36,0,0,0,0},{43,1,0,1,0},{36,0,0,0,0},{36,1,0,0,0}}},

    // 10 — scura e spinta, ottave in contrasto
    {"Obsidian Pulse",  320.f,.88f,.78f,.40f,.82f,.78f,.42f,.0f,136.f,1,
     .250f,.40f,.08f,.45f,.05f, 16,
     {{36,1,1,0,0},{36,1,0,0,0},{48,1,0,1,0},{46,1,0,0,0},
      {43,1,0,0,0},{39,1,0,0,0},{36,1,0,0,0},{43,1,0,0,0},
      {39,1,1,0,0},{36,1,0,0,0},{46,1,0,1,0},{43,1,0,0,0},
      {39,1,0,0,0},{37,1,0,1,0},{36,1,0,0,0},{48,1,0,0,0}}}
}};
